...
import { queryMessages, getThread, search } from '../core/query.js'
...
export const tools = {
  ...
  slack_dm: {
    ...
    handler: (args, ctx) =>
      dm({ botToken: ctx.env.SLACK_BOT_TOKEN, userId: args.userId, text: args.text, config: ctx.config, dryRun: args.dryRun }),
  },
  slack_post_as_user: {
